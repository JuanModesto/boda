...
var map_initial_latitude = 4.79329279156114;           //Google map initial Latitude. If "null", the latitude of the first marked will be used
var map_initial_longitude = -74.1802713797317;        //Google map initial Longitude. If "null", the longitude of the first marked will be used
...
var map_markers = [
    {
        ...
        "latitude": 4.79329279156114,
        "longitude": -74.1802713797317,
        "icon": "fas fa-bell", //Check the full list of icons at http://fortawesome.github.io/Font-Awesome/icons/
        "infoWindow": "Hacienda Salamanca <br> Tenjo, Cundinamarca"
    }
];